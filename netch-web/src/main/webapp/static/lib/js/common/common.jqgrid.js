  ...
  $.extend($.fn, {
    ...
    removeGridData : function(ids) {
      ...
      return this;
         ...
         * 清除所有 grid 內容
         */
        removeAllGridData : function() {
          this.jqGrid('clearGridData', true).trigger('reloadGrid');
          return this;
        },
    /**
     * 自動設定寬度
    ...
    if ((this.is("div") || !this.is("[role=grid]")) && typeof arguments[0] === 'object') {
      ...
      var s = $.extend({}, {
        ...
        loadComplete: function(){
                var jqgrid = $(".r-grid");
                jqgrid.addClass("row");
                // console.debug(jqgrid);
                // console.debug('.ui-jqrid length='+ jqgrid.find('.ui-jqgrid').length);
