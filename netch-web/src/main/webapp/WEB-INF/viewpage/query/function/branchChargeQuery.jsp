...
<title>
	<spring:message code="js.branchChargeQuery.title"><!--月收費彙整--></spring:message>
</title>
</head>
<body>
<div class="tr01">
    <script>
          loadScript('js/query/function/branchChargeQuery');
        </script>
        	...
        	<table width="100%" cellpadding="2" cellspacing="2" style="margin: 10px 0px;">
				<tr>
					...
					<td width="92%" class="style1">
						<h3><spring:message code="js.branchChargeQuery.title"><!--月收費彙整--></spring:message></h3>
					</td>
				</tr>
			</table>			
		</div>
        ...
        <div class="rowMargin">
	        <form id="mform" onsubmit="return false;">
			    <div class="row row-flex">
			      <div class="col-sm-12 col-xs-12 hd_style_2"><spring:message code="js.branchChargeQuery.tableTitle"><!--查詢條件--></spring:message></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchChargeQuery.inputYearMonth"><!--時間--></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1">
			      	<select id="inputYear" name="inputYear" combotype="2"></select>
					<spring:message code="js.branchChargeQuery.year"><!--年--></spring:message>
					<select id="inputMonth" name="inputMonth" combotype="2"></select>
					<spring:message code="js.branchChargeQuery.month"><!--月--></spring:message>
			      </div>
			    </div>
	        </form>
        </div>
