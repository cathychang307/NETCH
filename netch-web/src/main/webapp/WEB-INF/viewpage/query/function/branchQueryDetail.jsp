...
<title>
	<spring:message code="js.branchQueryDetail.title"><!--查詢明細--></spring:message>
</title>
</head>
<body>
<div class="tr01">
    <script>
          loadScript('js/query/function/branchQueryDetail');
        </script>
        	...
        	<table width="100%" cellpadding="2" cellspacing="2" style="margin: 10px 0px;">
				<tr>
					...
					<td width="92%" class="style1">
						<h3><spring:message code="js.branchQueryDetail.title"><!--查詢明細--></spring:message></h3>
					</td>
				</tr>
			</table>			
		</div>
        ...
        <div class="rowMargin">
	        <form id="mform" onsubmit="return false;">
			    <div class="row row-flex">
			      <div class="col-sm-12 col-xs-12 hd_style_2"><spring:message code="js.branchQueryDetail.tableTitle"><!--查詢條件--></spring:message></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchQueryDetail.table.title.01"><!--時間(起)--></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1"><input type="text" id="startDate" name="startDate" class="date"/></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchQueryDetail.table.title.02"><!--時間(迄)--></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1"><input type="text" id="endDate" name="endDate" class="date"/></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchQueryDetail.table.title.04"><!--查詢人ID--></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1"><input type="text" id="inquiryAccount" name="inquiryAccount" style="width: 75%"/></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchQueryDetail.table.title.05"><!--查詢類型--></spring:message></div>
