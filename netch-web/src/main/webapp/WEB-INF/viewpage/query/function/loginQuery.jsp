...
<title>
	<spring:message code="js.loginQuery.title"><!--登入登出記錄查詢--></spring:message>
</title>
</head>
<body>
<div class="tr01">
    <script>
          loadScript('js/query/function/loginQuery');
        </script>
        	...
        	<table width="100%" cellpadding="2" cellspacing="2" style="margin: 10px 0px;">
				<tr>
					...
					<td width="92%" class="style1">
						<h3><spring:message code="js.loginQuery.title"><!--登入登出記錄查詢--></spring:message></h3>
					</td>
				</tr>
			</table>			
		</div>
        ...
        <div class="rowMargin">
	        <form id="mform" onsubmit="return false;">
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.loginQuery.table.title.01"><!--使用者ID --></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1"><input type="text" id="userId" name="userId" style="width:75%;"/></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.loginQuery.table.title.02"><!--單位代號 --></spring:message></div>
			    ...
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.loginQuery.table.title.03"><!--起始時間 --></spring:message></div>
			      <div class="col-sm-8 col-xs-12 td_style_1"><input type="text" id="startDate" name="startDate" class="date"/></div>
			    </div>
			    <div class="row row-flex">
			      <div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.loginQuery.table.title.04"><!--結束時間--></spring:message></div>
