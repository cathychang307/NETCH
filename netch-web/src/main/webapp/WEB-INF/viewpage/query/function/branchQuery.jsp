...
<html>
    <head>
        <meta name="decorator" content="none">
            <title>
                <spring:message code="branchQuery.title">
                    <!--分行基本資料查詢-->
                </spring:message>
            </title>
        </head>
        ...
        <div class="tr01">
            <script>
                loadScript('js/query/function/branchQuery');
            </script>
			...
			<form method="POST" id="actionForm" name="actionForm" class="form-horizontal" role="form" onsubmit="return false;" autocomplete="off">
				<div class="rowMargin">
						<div class="row row-flex">
							<div class="col-sm-4 col-xs-12 hd_style_1"><spring:message code="js.branchQuery.grid.title.01"><!--單位代號--></spring:message></div>
