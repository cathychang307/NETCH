...
<body>
    <div class="tr01">
        <script>
                  loadScript('js/query/function/multiQueryDetail');
                </script>
        ...
        <form method="POST" id="actionForm" name="actionForm" class="form-horizontal" role="form" onsubmit="return false;" autocomplete="off">
            ...
            <c:forEach var="seq" begin="1" end="${maxQueryCount}" step="1">

                <c:choose>

                    <%-- 二欄位以下同一行 --%>
                    <c:when test="${ fn:length( queryDef.queryInputFieldDefinition ) <= 2 }">
                        <div class="row row-flex">
                            <div class="pull-left col-sm-1 col-xs-12 hd_style_1">${seq}</div>
                            <div class="col-sm-11 col-xs-12 td_style_1">
                                <c:forEach items="${queryDef.queryInputFieldDefinition }" var="fieldDef" varStatus="fieldDefStatus">
                                    <c:set var="currentFieldName" value="${fieldDef.fieldName }_${seq - 1 }" scope="page" />
            ...
            <div class="row row-flex">
                <div class="col-sm-1 col-xs-12 hd_style_1" align="center">
                    <label for="memo" class="control-label"> <spring:message code="multiQuery.memo">
                            <!--說明-->
                        </spring:message>
                    </label>
                </div>
                <div class="col-sm-11 col-xs-12 td_style_1">
                    ...
                    <div class="text-red" style="padding: 20px;">
                        <spring:message code="multiQuery.notice.require">
                            <!--(*)表示必須輸入-->
                        </spring:message>
                    </div>
                </div>
