        ...
        <div class="row rowMargin">
            <div class="row row-flex">
                ...
                <div class="col-sm-11 col-xs-12 style1">
                    <h2><spring:message code="singleQuery.queryMode">
                        <!--請選擇單筆查詢類別-->
                    </spring:message></h2>
                </div>
            </div>
        ...
        <form method="POST" id="actionForm" name="actionForm" class="form-horizontal" role="form" onsubmit="return false;" autocomplete="off">
            ...
            <div class="row row-flex">
                <div class="col-sm-12 col-xs-12 hd_style_1">
                    <span><spring:message code="singleQuery.msg.1">
                    ...
                    <div class="col-sm-4 col-xs-12 td_style_1">
                        <span class="btns">
                            <button type="button" id="query${rateType.transactionShortDesc }" name="query${rateType.transactionShortDesc }" class="btn btn-default"
                                onclick="$.ajax({url: url('singlequeryhandler/inquiry'), data: {'inputTransactionId': '${rateType.transactionShortDesc }'}}).done(function(){router.to('function/singleQueryDetail');});return false;">${rateType.key.transactionId}</button>
                        </span>
                    </div>
                    <div class="col-sm-8 col-xs-12 td_style_1">
                        <c:choose>
                            <c:when test="${'4111' == rateType.key.transactionId }">
                                <span><spring:message code="singleQuery.inquiryById">
                                        <!-- 依個人統一編號查詢 -->
                                    </spring:message></span>
                            </c:when>
                            <c:when test="${'4112' == rateType.key.transactionId }">
                                <span><spring:message code="singleQuery.inquiryByCompany">
                                        <!-- 依公司行號查詢 -->
                                    </spring:message></span>
                            </c:when>
                            <c:when test="${'4113' == rateType.key.transactionId }">
                                <span><spring:message code="singleQuery.inquiryByBankAccount">
                                        <!-- 依銀行代號及帳號查詢 -->
                                    </spring:message></span>
                            </c:when>
                            <c:otherwise>
            ...
            <div class="row row-flex">
                <div class="col-sm-12 col-xs-12 hd_style_1">
                    <span><spring:message code="singleQuery.msg.2">
            ...
            <div class="row row-flex">
                <div class="col-sm-12 col-xs-12 hd_style_1">
                    <span><spring:message code="singleQuery.msg.3">
                            <!-- 提供被查詢者最近三年內全部列管資訊。 -->
                        </spring:message></span>
                </div>
            </div>
            ...
            <div class="row row-flex">
                <div class="col-sm-12 col-xs-12 hd_style_1">
                    <spring:message code="singleQuery.msg.3">
                        <!-- 提供被查詢者最近三年內全部列管資訊。 -->
                    </spring:message>
                    </span>
                </div>
            ...
            <div class="row row-flex">
                <div class="col-sm-12 col-xs-12 hd_style_1">
                    <spring:message code="singleQuery.msg.1">
                        <!-- 提供被查詢者最近三年內退票總張數、總金額及其他相關資訊。 -->
                    </spring:message>
                    </span>
                </div>
