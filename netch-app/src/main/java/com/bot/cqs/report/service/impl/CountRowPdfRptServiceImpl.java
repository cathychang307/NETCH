 ...
 */
@Service
public class CountRowPdfRptServiceImpl extends AbstractJasperPdfService implements CountRowPdfRptService {
    ...
    public Map<String, Object> excute(Request request) {
        ...
        String reportName = "1".equals(queryMode) ? CapAppContext.getMessage("js.report.reportName.countRow") : CapAppContext.getMessage("js.report.reportName.branchCountRow");
